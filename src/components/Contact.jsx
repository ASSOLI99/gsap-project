    ...
    <div id='contact' className='my-20 min-h-96 w-screen px-10'>
      <div className='relative rounded-lg py-24 bg-black text-blue-50 sm:overflow-hidden'>
          ...
          <div className='absolute -left-20 top-0 hidden h-full w-72 overflow-hidden sm:block lg:left-20 lg:w-96'>
              ...
              <ImageClipBox src="/img/contact-2.webp" clipClass="hidden md:block contact-clip-path-2 -translate-y-64 translate-x-42" />
          </div>

          <div className='absolute -top-5/12 left-20 w-60 sm:top-1/2 md:left-auto md:right-10 lg:top-20 lg:w-80'>
